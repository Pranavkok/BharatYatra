  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right Side - Fairy Image */}
        <motion.div
          initial={{ x: 100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ delay: 0.2, type: 'spring', stiffness: 200, damping: 20 }}
          className="w-full md:w-2/5 bg-gradient-to-br from-pink-100 via-purple-100 to-indigo-100 relative flex items-center justify-center p-6 min-h-[300px]"
        >
          {/* Sparkle effects */}
          <motion.div
          ...
          <motion.img
            src="/asset/fairy.png"
            alt="Magical Fairy"
            className="max-h-[350px] object-contain drop-shadow-2xl relative z-10"
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              className="w-48 h-48 bg-gradient-to-br from-pink-300/50 to-purple-400/50 rounded-full blur-3xl"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.5, 0.8, 0.5],
              }}
